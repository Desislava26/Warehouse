    ...
    public class HomeController : BaseController
    {
        ...
        public async Task<IActionResult> UploadFile(IFormFile file)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData[MessageConstant.ErrorMessage] = "There was a problem with recording the file";
            }

            TempData[MessageConstant.SuccessMessage] = "The file is uploaded succsessfully";
